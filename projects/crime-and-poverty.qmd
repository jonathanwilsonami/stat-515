...
nice_colorbar <- function(width_mm = 180, height_mm = 10,
                          title_size = 13, label_size = 12) {
  guide_colorbar(
    title.position = "top",
    label.position = "bottom",
    barwidth  = unit(width_mm, "mm"),
    barheight = unit(height_mm, "mm"),
    ticks = FALSE,
    title.theme = element_text(size = title_size, face = "bold", margin = margin(b = 4)),
    label.theme = element_text(size = label_size)
  )
}
